...
public class BubbleSortController implements Initializable {
    ...
    public ImageView imgBackBtn, imgChatbotBtn;
    ...
    private void writeDataJSON() {
        dataJSON.put("type", "bubblesort");
        dataJSON.put("size", arrayNodes.size());
        dataJSON.put("originalArray", numbers.toString());
        dataJSON.put("swapCount", swapCount);
        ChatService.updateData(dataJSON);
    }

    private void writeSwapsJSON() {
        dataJSON.put("type", "bubblesort");
        dataJSON.put("size", arrayNodes.size());
        dataJSON.put("sortedArray", numbers.toString());
        dataJSON.put("swapCount", swapCount/5);
        ChatService.updateData(dataJSON);
    }

    private void clearSwapsJSON(){
        dataJSON.put("size", arrayNodes.size());
        dataJSON.put("originalArray", numbers.toString());
        dataJSON.put("sortedArray", numbers.toString());
        dataJSON.put("swapCount", swapCount);
